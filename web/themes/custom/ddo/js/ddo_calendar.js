          ...
          $(".single-day div.inner").each(function (index) {
            ...
            if (nb_points) {
              ...
              container_points = $("<div></div>", {
                class:
                  "group-show-points-domainedo group-size-" +
                  width_container_points,
              ...
              $(this).click(function () {
                ...
                $(".selected-day-domainedo").removeClass(
                  "selected-day-domainedo"
                );
                ...
                if ($(window).width() < 993) {
                  $("html,body").animate(
                    {
                      scrollTop:
                        $("#calendar-detail-domainedo").offset().top + 130,
                    },
                    "slow"
                  );
                }
              ...
              $(".view-item", $(this)).each(function (num) {
                ...
                if (num == 0) {
                  ...
                  td_date = $(
                    ".date-box[data-date='" + date_short_english + "']"
                  );
                  ...
                  let formattedDate = new Date(
                    $(this).parents("td").attr("date-date")
                  );
                  right_date = $("<div></div>", {
                    class: "right-date",
                    text: formattedDate.toLocaleDateString("fr-FR", {
                      year: "numeric",
                      month: "long",
                      day: "numeric",
                    }),
                ...
                content_type = $(".title-show-event", $(this)).attr(
                  "data-type"
                );
